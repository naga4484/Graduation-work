...
public class TchResendVerificationCodeAction extends Action {
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (email != null) {
            ...
            return "teacher_reset_password_code.jsp";  // 確認コード入力ページのままにする
        } else {
            request.setAttribute("errorMessage", "メールアドレスが見つかりません。最初からやり直してください。");
            return "teacher_reset_password_email.jsp";  // エラーメッセージと共にメールアドレス入力ページに戻る
        }
    }
